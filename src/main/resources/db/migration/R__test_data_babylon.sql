...
VALUES ('767946c2-e2cc-4f07-baec-df63807c5bd9', 'Babylon Notarissen', 'YegyMzuusT2k1Tq8bcTOyvtINed');

select @walletId := id
from wallet
where external_key = '767946c2-e2cc-4f07-baec-df63807c5bd9';

UPDATE wallet
SET display_name = 'Babylon Notarissen'
WHERE id = @walletId;

INSERT IGNORE INTO wallet_key (wallet_id, kid, display_name, document, created_at, created_by, last_modified_at, last_modified_by) VALUES (@walletId, 'GBd6z6M6TJf1U5H7_hiTneCwLUvmd1q4ioiVbKni8kk', 'Babylon JWK Key', '{"type":"jwk","jwk":"{\\"kty\\":\\"EC\\",\\"d\\":\\"6idxjL80BW2JSOSXSDYciGolC0TbAYepmKj_fqL__6I\\",\\"crv\\":\\"P-256\\",\\"kid\\":\\"GBd6z6M6TJf1U5H7_hiTneCwLUvmd1q4ioiVbKni8kk\\",\\"x\\":\\"NVJndbi6ZzmoDOlTYl56i_6XB5gF6H2LpIxC1YaPlpw\\",\\"y\\":\\"V-Ge7TUxKyGpztuwSiAxSEVqeR7atCMNcE-W4LYQqpM\\"}"}', '2024-06-29 08:44:28', 'System', '2024-06-29 08:44:28', 'System');

select @walletKeyId := id
from wallet_key
where wallet_id = @walletId
  and kid = 'GBd6z6M6TJf1U5H7_hiTneCwLUvmd1q4ioiVbKni8kk';

select @did := 'did:jwk:eyJrdHkiOiJFQyIsImNydiI6IlAtMjU2Iiwia2lkIjoiR0JkNno2TTZUSmYxVTVIN19oaVRuZUN3TFV2bWQxcTRpb2lWYktuaThrayIsIngiOiJOVkpuZGJpNlp6bW9ET2xUWWw1NmlfNlhCNWdGNkgyTHBJeEMxWWFQbHB3IiwieSI6IlYtR2U3VFV4S3lHcHp0dXdTaUF4U0VWcWVSN2F0Q01OY0UtVzRMWVFxcE0ifQ';
...
(select wallet.id,
        ...
        'https://babylonnotaris.acc.credenco.com/.well-known/openid-credential-issuer',
        'https://babylonnotaris.acc.credenco.com/',
        ''
from wallet
...
VALUES (@walletId, 'JWK', @did, '{"@context":["https://www.w3.org/ns/did/v1","https://w3id.org/security/suites/jws-2020/v1"],"id":"did:jwk:eyJrdHkiOiJFQyIsImNydiI6IlAtMjU2Iiwia2lkIjoiR0JkNno2TTZUSmYxVTVIN19oaVRuZUN3TFV2bWQxcTRpb2lWYktuaThrayIsIngiOiJOVkpuZGJpNlp6bW9ET2xUWWw1NmlfNlhCNWdGNkgyTHBJeEMxWWFQbHB3IiwieSI6IlYtR2U3VFV4S3lHcHp0dXdTaUF4U0VWcWVSN2F0Q01OY0UtVzRMWVFxcE0ifQ","verificationMethod":[{"id":"did:jwk:eyJrdHkiOiJFQyIsImNydiI6IlAtMjU2Iiwia2lkIjoiR0JkNno2TTZUSmYxVTVIN19oaVRuZUN3TFV2bWQxcTRpb2lWYktuaThrayIsIngiOiJOVkpuZGJpNlp6bW9ET2xUWWw1NmlfNlhCNWdGNkgyTHBJeEMxWWFQbHB3IiwieSI6IlYtR2U3VFV4S3lHcHp0dXdTaUF4U0VWcWVSN2F0Q01OY0UtVzRMWVFxcE0ifQ#0","type":"JsonWebKey2020","controller":"did:jwk:eyJrdHkiOiJFQyIsImNydiI6IlAtMjU2Iiwia2lkIjoiR0JkNno2TTZUSmYxVTVIN19oaVRuZUN3TFV2bWQxcTRpb2lWYktuaThrayIsIngiOiJOVkpuZGJpNlp6bW9ET2xUWWw1NmlfNlhCNWdGNkgyTHBJeEMxWWFQbHB3IiwieSI6IlYtR2U3VFV4S3lHcHp0dXdTaUF4U0VWcWVSN2F0Q01OY0UtVzRMWVFxcE0ifQ","publicKeyJwk":{"kty":"EC","crv":"P-256","kid":"GBd6z6M6TJf1U5H7_hiTneCwLUvmd1q4ioiVbKni8kk","x":"NVJndbi6ZzmoDOlTYl56i_6XB5gF6H2LpIxC1YaPlpw","y":"V-Ge7TUxKyGpztuwSiAxSEVqeR7atCMNcE-W4LYQqpM"}}],"assertionMethod":["did:jwk:eyJrdHkiOiJFQyIsImNydiI6IlAtMjU2Iiwia2lkIjoiR0JkNno2TTZUSmYxVTVIN19oaVRuZUN3TFV2bWQxcTRpb2lWYktuaThrayIsIngiOiJOVkpuZGJpNlp6bW9ET2xUWWw1NmlfNlhCNWdGNkgyTHBJeEMxWWFQbHB3IiwieSI6IlYtR2U3VFV4S3lHcHp0dXdTaUF4U0VWcWVSN2F0Q01OY0UtVzRMWVFxcE0ifQ#0"],"authentication":["did:jwk:eyJrdHkiOiJFQyIsImNydiI6IlAtMjU2Iiwia2lkIjoiR0JkNno2TTZUSmYxVTVIN19oaVRuZUN3TFV2bWQxcTRpb2lWYktuaThrayIsIngiOiJOVkpuZGJpNlp6bW9ET2xUWWw1NmlfNlhCNWdGNkgyTHBJeEMxWWFQbHB3IiwieSI6IlYtR2U3VFV4S3lHcHp0dXdTaUF4U0VWcWVSN2F0Q01OY0UtVzRMWVFxcE0ifQ#0"],"capabilityInvocation":["did:jwk:eyJrdHkiOiJFQyIsImNydiI6IlAtMjU2Iiwia2lkIjoiR0JkNno2TTZUSmYxVTVIN19oaVRuZUN3TFV2bWQxcTRpb2lWYktuaThrayIsIngiOiJOVkpuZGJpNlp6bW9ET2xUWWw1NmlfNlhCNWdGNkgyTHBJeEMxWWFQbHB3IiwieSI6IlYtR2U3VFV4S3lHcHp0dXdTaUF4U0VWcWVSN2F0Q01OY0UtVzRMWVFxcE0ifQ#0"],"capabilityDelegation":["did:jwk:eyJrdHkiOiJFQyIsImNydiI6IlAtMjU2Iiwia2lkIjoiR0JkNno2TTZUSmYxVTVIN19oaVRuZUN3TFV2bWQxcTRpb2lWYktuaThrayIsIngiOiJOVkpuZGJpNlp6bW9ET2xUWWw1NmlfNlhCNWdGNkgyTHBJeEMxWWFQbHB3IiwieSI6IlYtR2U3VFV4S3lHcHp0dXdTaUF4U0VWcWVSN2F0Q01OY0UtVzRMWVFxcE0ifQ#0"],"keyAgreement":["did:jwk:eyJrdHkiOiJFQyIsImNydiI6IlAtMjU2Iiwia2lkIjoiR0JkNno2TTZUSmYxVTVIN19oaVRuZUN3TFV2bWQxcTRpb2lWYktuaThrayIsIngiOiJOVkpuZGJpNlp6bW9ET2xUWWw1NmlfNlhCNWdGNkgyTHBJeEMxWWFQbHB3IiwieSI6IlYtR2U3VFV4S3lHcHp0dXdTaUF4U0VWcWVSN2F0Q01OY0UtVzRMWVFxcE0ifQ#0"]}',
...
values (@walletId, 'aktes', 'Aktes', '', 'https://babylonnotaris.acc.credenco.com', now(), 'System', now(), 'System');
...
values
    (@credential_issuer_id, 'Babylon Notarissen', 'https://babylonnotaris.acc.credenco.com/card_logo.png', 'Babylon logo', null),
    (@credential_issuer_id, 'Babylon Notarissen', null, null, 'nl-NL'),
    (@credential_issuer_id, 'Babylon Notary', null, null, 'en-US');
...
VALUES (@walletId, 'pid', 'Inloggen met PID', 'Configuratie voor inloggen met personal ID', 'We willen graag uw PersonalID ontvangen om in te loggen', null, null, 'https://babylonnotaris.acc.credenco.com', null, '2024-06-30 11:48:47', 'System', '2024-06-30 11:48:47', 'System');
